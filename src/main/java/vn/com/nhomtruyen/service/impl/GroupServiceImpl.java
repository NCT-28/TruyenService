...
public class GroupServiceImpl implements GroupService {
	 ...
	 * @param groupMapper
	 */
	public GroupServiceImpl(GroupRepository groupRepository, UserTruyenRepository userRepository,
			RoleRepository roleRepository, GroupMapper groupMapper) {
		super();
	 ...
	 */
	@Override
	public GroupMess getAllGroup(Integer pageNo, Integer pageSize, String name, String description,
		...
		Page<Group> enties = groupRepository.findAllGroup(pageable, name, description);
